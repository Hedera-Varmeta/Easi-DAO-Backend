var socket = require('socket.io-client')(process.env.SOCKET_URL || 'http://localhost:3032');
...
export class SocketService {
    async sendToSocket(data, event) {
        try {
            ...
            console.log(`sendToSocket:: socket url: ${process.env.SOCKET_URL || 'http://localhost:3032'}`);
